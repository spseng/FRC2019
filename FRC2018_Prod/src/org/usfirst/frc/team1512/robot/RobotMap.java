...
public class RobotMap {
	...
	public static DoubleSolenoid grabber = new DoubleSolenoid(0, 1);
	public static DoubleSolenoid solenoid3 = new DoubleSolenoid(2, 3);
	public static DoubleSolenoid solenoid4 = new DoubleSolenoid(4, 5);
